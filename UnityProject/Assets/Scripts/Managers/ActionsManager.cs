...
public class ActionsManager : MonoBehaviour {
	...
	float weekLength = TimeManager.instance.weekLength;
	...
	void Start () {
		...
		//'Research' actions
		possibleActions.Add(new PlayerAction("Build unnecessary landmarks",
		...
		possibleActions.Add(new PlayerAction("Encourage young professionals",
		...
		possibleActions.Add (new PlayerAction ("Call the police!",
		...
		possibleActions.Add(new PlayerAction("Can I haz some help?",
		...
		possibleActions.Add(new PlayerAction("Hola gringo!","Show people Wavestan is a nice place to live (and lure some professionals while you're at it",
		...
		possibleActions.Add(new PlayerAction("They don't look so bad, right?",
		...
		possibleActions.Add (new PlayerAction ("Mikasa, su casa s2",
		...
		possibleActions.Add(new PlayerAction("Build Houses","Get those puppies up so people can rest a little",
			300,1.5f*weekLength,MiscInfo.variableTypes.availableHouses,1));

		possibleActions.Add(new PlayerAction("Purchase social resources","Everyone needs some soup and some soap",
			100,1*weekLength,MiscInfo.variableTypes.socialResources,1));

		possibleActions.Add(new PlayerAction("Hire Border Officers","Those borders won't defend themselves",
			125,2*weekLength,MiscInfo.variableTypes.availableBO,1));

		possibleActions.Add(new PlayerAction("Build Border Resources","Fuel and ammo aren't free, you know.",
